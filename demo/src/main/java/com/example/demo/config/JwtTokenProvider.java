...
public class JwtTokenProvider {
    ...
    // 토큰의 Claim 추출 -> 권한 정보 -> User 객체를 생성하여 Authentication 객체 반환
    public Authentication getAuthentication(String accessToken) {
        ...
        //UserDetail 객체 생성, 주체와 권환정보, 필요한 기타 설정들을 넣는 과정
    ...
    //accessToken을 받아와서, 암호화된 것을 복호화해서 반환
    //JWT 복호화하면서, 토큰 검증 & 토큰 만료를 확인
